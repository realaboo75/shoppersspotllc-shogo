...
export const Alert = ({ className, variant, ...props }: React.HTMLAttributes<HTMLDivElement> & VariantProps<typeof alertVariants>) => <div role="alert" className={cn(alertVariants({ variant }), className)} {...props} />
